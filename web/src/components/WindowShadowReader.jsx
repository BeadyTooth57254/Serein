...
export function WindowShadowReader({
  ...
  return (
    <ReadingLayer title="窗影" titleId="window-shadow-reader-title" label="WINDOW SHADOWS" closeLabel="关闭窗影" onClose={onClose} closeButtonRef={closeButtonRef} className="" readerClassName={['', mobileDetailOpen ? "is-mobile-detail-open" : ""].join(" ")}>
